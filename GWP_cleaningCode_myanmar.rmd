...
The version of the Gallup raw data used in this study is "The_Gallup_0211626.dat". 

This data was released to the [UofT Map and Data Library](https://mdl.library.utoronto.ca/collections/numeric-data/gallup) in January 2026.
...
# Import the data file "The_Gallup_021126.dat"
gallupRaw <- rio::import("~/Documents/GitHub/DATA/The_Gallup_021126.dat")
...
varRequired <- c(
  ...
  "WP150", "WP16", "WP18", "WP22", "WP27",
  "WP3117", "WP4", "WP40", "WP43", 
  "WP59", "WP60", "WP61", "WP63", "WP64", "WP65", "WP67", "WP68", "WP69",
  "WP70", "WP71", "WP74", "WP76", "WP98", "WPID", "YEAR_CALENDAR", "YEAR_WAVE", 
  "WP30", "WP31", "WP3120"
)
...
saveRDS(gallupSubset, "(260211)GWP_RawSubset_MyanmarProject.rds")
```
...
# Read the RDS file
gallupSubset <- readRDS("data/(260211)GWP_RawSubset_MyanmarProject.rds")
objects(gallupSubset)
```
...
gallup <- gallup %>%
  mutate(
         ...
         WP1233RECODED = ifelse(WP1233RECODED %in% c(8, 98, 99), NA, WP1233RECODED),
         ...
         WP22 = ifelse(WP22 %in% c(3, 4), NA, WP22),
         WP27 = ifelse(WP27 %in% c(3, 4), NA, WP27),
         ...
         WP59 = ifelse(WP59 %in% c(3, 4), NA, WP59),
         WP60 = ifelse(WP60 %in% c(3, 4), NA, WP60),
         WP61 = ifelse(WP61 %in% c(3, 4), NA, WP61),
         WP63 = ifelse(WP63 %in% c(3, 4), NA, WP63),
         WP64 = ifelse(WP64 %in% c(3, 4), NA, WP64),
         WP65 = ifelse(WP65 %in% c(3, 4), NA, WP65),
         WP67 = ifelse(WP67 %in% c(3, 4), NA, WP67),
         WP68 = ifelse(WP68 %in% c(3, 4), NA, WP68),
...
gallup <- gallup %>%
  mutate(
    ...
    WP22 = ifelse(WP22 == 2, 0, WP22),
    WP27 = ifelse(WP27 == 2, 0, WP27),
    WP30 = ifelse(WP30 == 2, 0, WP30),
    WP40 = ifelse(WP40 == 2, 0, WP40),
    WP43 = ifelse(WP43 == 2, 0, WP43),
    WP59 = ifelse(WP59 == 2, 0, WP59),
    WP60 = ifelse(WP60 == 2, 0, WP60),
    WP61 = ifelse(WP61 == 2, 0, WP61),
    WP63 = ifelse(WP63 == 2, 0, WP63),
    WP64 = ifelse(WP64 == 2, 0, WP64),
    WP65 = ifelse(WP65 == 2, 0, WP65),
    WP67 = ifelse(WP67 == 2, 0, WP67),
    WP68 = ifelse(WP68 == 2, 0, WP68),
...
saveRDS(gallup, "data/(260211)GWP_cleaned_MyanmarProject.rds")
```
