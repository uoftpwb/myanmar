...
This data was released to the [UofT Map and Data Library](https://mdl.library.utoronto.ca/collections/numeric-data/gallup) in September 2025.
...
# Import the data file "The_Gallup_091925.dat"
gallupRaw <- rio::import("~/Documents/GitHub/DATA/The_Gallup_091925.dat")
...
saveRDS(gallupSubset, "(250918)GWP_RawSubset_MyanmarProject.rds")
```
...
# Read the RDS file
gallupSubset <- readRDS("data/(250918)GWP_RawSubset_MyanmarProject.rds")
...
saveRDS(gallup, "data/(250918)GWP_cleaned_MyanmarProject.rds")
```
